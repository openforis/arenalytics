...
.tr_keys <- function() {
  list(
    ...
    ## Home UI
    hero_title = "Powerful analytics for your Open Foris Arena data",
    hero_txt = "Explore your data from Open Foris Arena, gain insights and develop report-ready figures and statistics.",
