...
with the layout `arenalytics_offline_pkgs/src/contrib/` containing the
`.tar.gz` files and a `PACKAGES` index — the standard CRAN repository
structure that R expects.
...
Share that zip along with this vignette with your users.
